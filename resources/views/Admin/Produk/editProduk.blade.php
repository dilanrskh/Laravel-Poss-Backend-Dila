            ...
            <div class="card">
                <form action="{{ route('dataProduk.update', $produk->id) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label>Stock</label>
                            <input type="text" name="stock" id="stock" value="{{ $produk->stock }}" required class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Image Produk</label>
                            <input type="file" name="image" id="image" value="{{ $produk->image }}" required class="form-control">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div>
                                <textarea class="summernote" name="deskripsi" value="{{ $produk->deskripsi }}" required>{{ $produk->deskripsi }}</textarea>
                            </div>
                        </div>
                        <div>
